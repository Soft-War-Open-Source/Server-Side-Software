...
public class RecommendationControllerTest {
    ...
    void findByDate() throws Exception
    {
        ...
        Recommendation recommendation = new Recommendation(1,nutritionistList.get(0),"pera","descripcionRandom1",ParseDate("2021-05-05"));
        given(recommendation.findByDate(date)).willReturn(recommendationList);
        mockMvc.perform(get("/api/nutritionist/searchByFirstname/{date}", nutritionist.getFirstName())).andExpect(status().isOk());
    }
    ...
    void findByName() throws Exception
    {
        ...
        Recommendation recommendation = new Recommendation(1,nutritionistList.get(0),"pera","descripcionRandom1",ParseDate("2021-05-05"));
        given(recommendation.findByDate(date)).willReturn(recommendationList);
        mockMvc.perform(get("/api/nutritionist/searchByName/{name}", nutritionist.getFirstName())).andExpect(status().isOk());
    }
